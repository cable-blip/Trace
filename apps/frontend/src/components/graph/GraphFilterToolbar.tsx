...
import { Filter, Sliders, Search, RefreshCw } from 'lucide-react';
...
export const GraphFilterToolbar: React.FC<GraphFilterToolbarProps> = ({
  ...
  return (
    <div className="bg-surface/95 backdrop-blur-md border border-surface-border rounded-lg p-3 text-xs font-sans space-y-2.5 shadow-xl">
