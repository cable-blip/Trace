...
import { FloatingLogo3D } from '../ui/FloatingLogo3D';
      ...
      >
        <div className="flex items-center justify-between h-full px-4 gap-3 w-full">
          ...
          <div className="flex items-center gap-3 shrink-0">
            {/* 3D Logo Badge with Moving Border + Floating 3D */}
            <FloatingLogo3D intensity={20} className="cursor-pointer">
            <MovingBorder borderRadius="0.5rem" duration={2000} className="w-[52px] h-[36px]">
              <div
                className="flex items-center justify-center w-full h-full text-xs font-black font-mono tracking-wider select-none cursor-default"
                style={{
                  fontSize: 11,
                  fontWeight: 900,
                  letterSpacing: '0.1em',
                  color: '#00FFFF',
                  background: 'linear-gradient(135deg, rgba(0,255,255,0.15) 0%, rgba(0,255,65,0.08) 100%)',
          ...
          >
            ...
            >
              {tabs.map(tab => {
                ...
                return (
                  <MagneticButton key={tab.id} strength={0.2} maxDistance={10}>
                  <button
          ...
          <div className="flex items-center gap-2 shrink-0">
            {onAudioBriefingClick && (
              <MagneticButton strength={0.3} maxDistance={15}>
              <button
